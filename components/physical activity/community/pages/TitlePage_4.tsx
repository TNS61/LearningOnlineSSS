...
export default function TitlePage_4() {
  ...
  const LeftTreeForeground = useParallax({
    ...
    targetElement: target.current,
    startScroll: 0.4,
    translateX: ["20vw", "-80vw"],
  });

  const RightTreeForeground = useParallax({
    speed: 1,
    targetElement: target.current,
    translateX: ["-80vw", "50vw", "easeInOut"],
  });
  ...
  return (
    ...
    >
      ...
      <div
        ...
        data-aos-duration="1000"
        data-aos-anchor-placement="top-bottom"
        className="fixed bottom-[-50%] right-0 z-[10] w-full "
      >
        <Image
      ...
      <div
        ...
        data-aos-duration="1000"
        data-aos-anchor-placement="top-bottom"
        className="fixed bottom-[-50%] left-[50%] z-[10] w-full "
      >
        <Image
